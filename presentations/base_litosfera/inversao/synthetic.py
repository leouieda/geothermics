...
cond_var = 0.00001         # linear coefficient for conductivity [K^-1] 
...
error = 10.     # Temperature standard deviation [K]
...
temps_adj = subcrust.synthetic_temp_profile(depths, inv_radheat, inv_condvar, 
                                        inv_flux, crust_temp, 
                                        conductivity, crust_depth)

pylab.plot(temps_adj - 273., depths*0.001, '-b')
